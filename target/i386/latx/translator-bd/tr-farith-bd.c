...
bool translate_fadd_bd(IR1_INST *pir1)
{
    lsassert(ir1_opnd_num_bd(pir1) == 2);

    IR2_OPND dest_opnd = load_freg_from_ir1_1_bd(ir1_get_opnd_bd(pir1, 0), false, true);
    IR2_OPND src1_opnd = load_freg_from_ir1_1_bd(ir1_get_opnd_bd(pir1, 1), false, true);
...
bool translate_faddp_bd(IR1_INST *pir1)
{
    lsassert(ir1_opnd_num_bd(pir1) == 2);
...
bool translate_fiadd_bd(IR1_INST *pir1)
{
    lsassert(ir1_opnd_num_bd(pir1) == 2);
    ...
    load_freg_from_ir1_2_bd(t_freg, opnd0, 0);
...
bool translate_fsub_bd(IR1_INST *pir1)
{
    lsassert(ir1_opnd_num_bd(pir1) == 2);
...
bool translate_fisub_bd(IR1_INST *pir1)
{
    lsassert(ir1_opnd_num_bd(pir1) == 2);
...
bool translate_fisubr_bd(IR1_INST *pir1)
{
    lsassert(ir1_opnd_num_bd(pir1) == 2);
...
bool translate_fsubr_bd(IR1_INST *pir1)
{
    lsassert(ir1_opnd_num_bd(pir1) == 2);
...
bool translate_fsubrp_bd(IR1_INST *pir1)
{
    lsassert(ir1_opnd_num_bd(pir1) == 2);
...
bool translate_fsubp_bd(IR1_INST *pir1)
{
    lsassert(ir1_opnd_num_bd(pir1) == 2);
...
bool translate_fmul_bd(IR1_INST *pir1)
{
    lsassert(ir1_opnd_num_bd(pir1) == 2);
...
bool translate_fimul_bd(IR1_INST *pir1)
{
    lsassert(ir1_opnd_num_bd(pir1) == 2);
...
bool translate_fmulp_bd(IR1_INST *pir1)
{
    lsassert(ir1_opnd_num_bd(pir1) == 2);

    IR2_OPND src0_opnd = load_freg_from_ir1_1_bd(ir1_get_opnd_bd(pir1, 0), false, true);
    IR2_OPND src1_opnd = load_freg_from_ir1_1_bd(ir1_get_opnd_bd(pir1, 1), false, true);
...
bool translate_fdiv_bd(IR1_INST *pir1)
{
    lsassert(ir1_opnd_num_bd(pir1) == 2);
...
bool translate_fdivr_bd(IR1_INST *pir1)
{
    lsassert(ir1_opnd_num_bd(pir1) == 2);
...
bool translate_fidiv_bd(IR1_INST *pir1)
{
    lsassert(ir1_opnd_num_bd(pir1) == 2);
...
bool translate_fidivr_bd(IR1_INST *pir1)
{
    lsassert(ir1_opnd_num_bd(pir1) == 2);
...
bool translate_fdivrp_bd(IR1_INST *pir1)
{
    lsassert(ir1_opnd_num_bd(pir1) == 2);

    IR2_OPND dest_opnd = load_freg_from_ir1_1_bd(ir1_get_opnd_bd(pir1, 0), false, true);
    IR2_OPND src1_opnd = load_freg_from_ir1_1_bd(ir1_get_opnd_bd(pir1, 0) + 1, false, true);
    la_fdiv_d(dest_opnd, src1_opnd, dest_opnd);
...
bool translate_fdivp_bd(IR1_INST *pir1)
{
    lsassert(ir1_opnd_num_bd(pir1) == 2);
...
bool translate_fnop_bd(IR1_INST *pir1)
{
    /* append_ir2_opnd0(mips_nop); */
    return true;
}

bool translate_fsqrt_bd(IR1_INST *pir1)
{
...
bool translate_fabs_bd(IR1_INST *pir1)
{
    IR2_OPND st0_opnd = ra_alloc_st(0);
...
bool translate_fchs_bd(IR1_INST *pir1)
{
    IR2_OPND st0_opnd = ra_alloc_st(0);
...
bool translate_fdecstp_bd(IR1_INST *pir1)
{
    tr_fpu_dec();
...
bool translate_fincstp_bd(IR1_INST *pir1)
{
    tr_fpu_inc();
...
bool translate_fsin_bd(IR1_INST *pir1)
{
...
bool translate_fcos_bd(IR1_INST *pir1)
{
...
bool translate_fscale_bd(IR1_INST *pir1)
{
    IR2_OPND st0_opnd = ra_alloc_st(0);
    IR2_OPND st1_opnd = ra_alloc_st(1);
...
bool translate_fxam_bd(IR1_INST *pir1)
{
    IR2_OPND st0_opnd = ra_alloc_st(0);
...
bool translate_f2xm1_bd(IR1_INST *pir1)
{
...
bool translate_fxtract_bd(IR1_INST *pir1)
{
...
bool translate_fyl2x_bd(IR1_INST *pir1)
{
...
bool translate_fyl2xp1_bd(IR1_INST *pir1)
{
...
bool translate_fsincos_bd(IR1_INST *pir1)
{
...
bool translate_fxch_bd(IR1_INST *pir1)
{
    lsassert(ir1_opnd_num_bd(pir1) == 2);
    IR2_OPND st0_opnd = ra_alloc_st(0);
    int opnd2_index = ir1_opnd_base_reg_num_bd(ir1_get_opnd_bd(pir1, 1));
...
bool translate_ftst_bd(IR1_INST *pir1)
{
    IR2_OPND status_word = ra_alloc_itemp();
...
bool translate_fptan_bd(IR1_INST *pir1)
{
    tr_gen_call_to_helper1((ADDR)helper_fptan, 1, LOAD_HELPER_FPTAN);
    return true;
}

bool translate_fisttp_bd(IR1_INST *pir1)
{
    ...
    if (ir1_opnd_size_bd(opnd0) == 32) {
        ...
        lsassertm(0, "Invalid operand size (%d) in %s.\n",
                    ir1_opnd_size_bd(opnd0), __func__);
    }
    la_movfr2gr_d(dest_int, fp_opnd);
    store_ireg_to_ir1_bd(dest_int, ir1_get_opnd_bd(pir1, 0), false);
    ra_free_temp(fp_opnd);
    ra_free_temp(dest_int);
    tr_fpu_pop();
    return true;
...
bool translate_fbstp_bd(IR1_INST *pir1)
{
    IR1_OPND_BD *opnd0 = ir1_get_opnd_bd(pir1, 0);
    IR2_OPND mem_opnd = convert_mem_no_offset_bd(opnd0);
 ...
 */
bool translate_fxsave_bd(IR1_INST *pir1)
{
    IR1_OPND_BD *opnd0 = ir1_get_opnd_bd(pir1, 0);
    IR2_OPND mem_opnd = convert_mem_no_offset_bd(opnd0);
...
bool translate_fxrstor_bd(IR1_INST *pir1)
{
    IR1_OPND_BD *opnd0 = ir1_get_opnd_bd(pir1, 0);
    IR2_OPND mem_opnd = convert_mem_no_offset_bd(opnd0);
