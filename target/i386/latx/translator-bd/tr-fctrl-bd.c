...
static void update_fcsr_flag_bd(IR2_OPND status_word, IR2_OPND fcsr)
{
...
static void update_fcsr_enable_bd(IR2_OPND control_word, IR2_OPND fcsr)
{
    IR2_OPND temp = ra_alloc_itemp();
...
void update_fcsr_by_sw_bd(IR2_OPND sw)
{
    ...
    update_fcsr_flag_bd(sw, old_fcsr);
...
void update_fcsr_by_cw_bd(IR2_OPND cw)
{
    ...
    update_fcsr_enable_bd(cw, fcsr);
    update_fcsr_rm_bd(cw, fcsr);
    la_movgr2fcsr(fcsr_ir2_opnd, fcsr);
    ra_free_temp(fcsr);
}
...
bool translate_fnstcw_bd(IR1_INST *pir1)
{
    ...
    if (ir1_opnd_is_mem_bd(opnd0)) {
        ...
        store_ireg_to_ir1_bd(cw_opnd, opnd0, false);
    }
...
bool translate_stmxcsr_bd(IR1_INST *pir1)
{
    ...
    store_ireg_to_ir1_bd(mxcsr_opnd, ir1_get_opnd_bd(pir1, 0), false);

    ra_free_temp(mxcsr_opnd);
    return true;
}

bool translate_ldmxcsr_bd(IR1_INST *pir1)
{
 ...
 */
static bool translate_fcomi_internal_bd(IR1_INST *pir1, bool unordered)
{
    bool is_zpc_def =
        ir1_is_zf_def_bd(pir1) || ir1_is_pf_def_bd(pir1) || ir1_is_cf_def_bd(pir1);
    bool is_osa_def =
        ir1_is_of_def_bd(pir1) || ir1_is_sf_def_bd(pir1) || ir1_is_af_def_bd(pir1);
    if (is_zpc_def || is_osa_def) {
        ...
        if (is_zpc_def) {
            ...
            IR2_OPND sti = load_freg_from_ir1_1_bd(ir1_get_opnd_bd(pir1, 1),
                false, true);
...
bool translate_fucomi_bd(IR1_INST *pir1)
{
    translate_fcomi_internal_bd(pir1, true);
    return true;
}

bool translate_fucomip_bd(IR1_INST *pir1)
{
    translate_fcomi_internal_bd(pir1, true);
    tr_fpu_pop();
    return true;
...
bool translate_fcomi_bd(IR1_INST *pir1)
{
    translate_fcomi_internal_bd(pir1, false);
    return true;
}

bool translate_fcomip_bd(IR1_INST *pir1)
{
    translate_fcomi_internal_bd(pir1, false);
    tr_fpu_pop();
...
static bool translate_fcom_internal_bd(IR1_INST *pir1, bool unordered)
{
#define C0_BIT (8)
#define C1_BIT (9)
#define C2_BIT (10)
#define C3_BIT (14)
    ...
    IR2_OPND src = load_freg_from_ir1_1_bd(ir1_get_opnd_bd(pir1, 1), false, true);
    IR2_OPND st0 = ra_alloc_st(0);
...
bool translate_fcom_bd(IR1_INST *pir1)
{
    translate_fcom_internal_bd(pir1, false);

    return true;
}

bool translate_fcomp_bd(IR1_INST *pir1)
{
    translate_fcom_internal_bd(pir1, false);
    tr_fpu_pop();
...
bool translate_fucom_bd(IR1_INST *pir1)
{
    translate_fcom_internal_bd(pir1, true);
    return true;
}

bool translate_fucomp_bd(IR1_INST *pir1)
{
    translate_fcom_internal_bd(pir1, true);
    tr_fpu_pop();
...
bool translate_fcompp_bd(IR1_INST *pir1)
{
    translate_fcom_internal_bd(pir1, false);
    tr_fpu_pop();
    tr_fpu_pop();
...
bool translate_fucompp_bd(IR1_INST *pir1)
{
    translate_fcom_internal_bd(pir1, true);
    tr_fpu_pop();
    tr_fpu_pop();
...
bool translate_ficom_bd(IR1_INST *pir1)
{
    ...
    load_freg_from_ir1_2_bd(mint_opnd, ir1_get_opnd_bd(pir1, 1), 0);
...
bool translate_ficomp_bd(IR1_INST *pir1)
{
    translate_ficom_bd(pir1);
    tr_fpu_pop();
    return true;
}

bool translate_ud2_bd(IR1_INST *pir1)
{
 ...
 */
bool translate_ffree_bd(IR1_INST *pir1)
{
    IR2_OPND fpu_tag = ra_alloc_itemp();
...
bool translate_ffreep_bd(IR1_INST *pir1)
{
    return false;
}

bool translate_fldenv_bd(IR1_INST *pir1)
{
...
bool translate_fnstenv_bd(IR1_INST *pir1)
{
    IR2_OPND value = ra_alloc_itemp();
    IR2_OPND temp = ra_alloc_itemp();
...
bool translate_wait_bd(IR1_INST *pir1)
{
    IR2_OPND temp = ra_alloc_itemp();
    IR2_OPND sw_opnd = ra_alloc_itemp();
...
bool translate_fnclex_bd(IR1_INST *pir1) {
...
bool translate_fninit_bd(IR1_INST *pir1) {
    IR2_OPND temp = ra_alloc_itemp();
    IR2_OPND fcsr0 = ra_alloc_itemp();
    int offset;
