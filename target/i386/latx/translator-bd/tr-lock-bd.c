...
IR2_OPND convert_mem_to_itemp_bd(IR1_OPND_BD *opnd0)
{
    ...
    mem_op = convert_mem_no_offset_bd(opnd0);
...
* @return
*/
bool translate_lock_sbb_bd(IR1_INST *pir1)
{
     ...
     * 具体看 generate_eflag_calculation_bd 函数里。
     */
    IR2_OPND src0, src1, dest, tmp;
    IR2_OPND mem_opnd;
    int opnd0_size = ir1_opnd_size_bd(opnd0);
...
* @return
*/
bool translate_lock_add_bd(IR1_INST *pir1)
{
    IR1_OPND_BD *opnd0 = ir1_get_opnd_bd(pir1, 0);
    IR1_OPND_BD *opnd1 = ir1_get_opnd_bd(pir1, 1);
...
* @return
*/
bool translate_lock_adc_bd(IR1_INST *pir1)
{
    IR1_OPND_BD *opnd0 = ir1_get_opnd_bd(pir1, 0);
    IR1_OPND_BD *opnd1 = ir1_get_opnd_bd(pir1, 1);
...
* @return
*/
bool translate_lock_and_bd(IR1_INST *pir1)
{
    IR1_OPND_BD *opnd0 = ir1_get_opnd_bd(pir1, 0);
    IR1_OPND_BD *opnd1 = ir1_get_opnd_bd(pir1, 1);
...
* @return
*/
bool translate_lock_inc_bd(IR1_INST *pir1)
{
    IR1_OPND_BD *opnd0 = ir1_get_opnd_bd(pir1, 0);
...
* @return
*/
bool translate_lock_dec_bd(IR1_INST *pir1)
{
    IR1_OPND_BD *opnd0 = ir1_get_opnd_bd(pir1, 0);
...
* @return
*/
bool translate_lock_sub_bd(IR1_INST *pir1)
{
    IR1_OPND_BD *opnd0 = ir1_get_opnd_bd(pir1, 0);
    IR1_OPND_BD *opnd1 = ir1_get_opnd_bd(pir1, 1);
...
* @return
*/
bool translate_lock_neg_bd(IR1_INST *pir1)
{
    IR1_OPND_BD *opnd0 = ir1_get_opnd_bd(pir1, 0);
...
* @return
*/
bool translate_lock_or_bd(IR1_INST *pir1)
{
    IR1_OPND_BD *opnd0 = ir1_get_opnd_bd(pir1, 0);
    IR1_OPND_BD *opnd1 = ir1_get_opnd_bd(pir1, 1);
...
* @return
*/
bool translate_lock_not_bd(IR1_INST *pir1)
{
    IR1_OPND_BD *opnd0 = ir1_get_opnd_bd(pir1, 0);
...
* @return
*/
bool translate_lock_xor_bd(IR1_INST *pir1)
{
    IR1_OPND_BD *opnd0 = ir1_get_opnd_bd(pir1, 0);
    IR1_OPND_BD *opnd1 = ir1_get_opnd_bd(pir1, 1);
...
* @return
*/
bool translate_lock_xadd_bd(IR1_INST *pir1)
{
    IR1_OPND_BD *opnd0 = ir1_get_opnd_bd(pir1, 0);
    IR1_OPND_BD *opnd1 = ir1_get_opnd_bd(pir1, 1);
...
* @return
*/
bool translate_lock_cmpxchg_bd(IR1_INST *pir1)
{
    IR1_OPND_BD *opnd0 = ir1_get_opnd_bd(pir1, 0);
    IR1_OPND_BD *opnd1 = ir1_get_opnd_bd(pir1, 1);
