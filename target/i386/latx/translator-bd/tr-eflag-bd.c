...
bool translate_popf_bd(IR1_INST *pir1)
{
...
bool translate_pushf_bd(IR1_INST *pir1)
{
#ifndef TARGET_X86_64
    const int sp_step = 4;
#else
...
bool translate_clc_bd(IR1_INST *pir1) {
    la_x86mtflag(zero_ir2_opnd, 0x1);
    return true;
}

bool translate_cld_bd(IR1_INST *pir1)
{
...
bool translate_stc_bd(IR1_INST *pir1) {
...
bool translate_std_bd(IR1_INST *pir1)
{
    IR2_OPND eflags = ra_alloc_eflags();
